...
const DOMAIN_INVITATION = 52;
const REFERRER_ASSIGNED = 105;  // Domain
const REFERRER_JOB_PAID = 106;  // Domain
const REFERRER_JOB_RECEIVED = 107;  // Domain
