...
const OPTIONS_ORDER_COMMON = [USER, JOB_INFO, JOB_DRAFTING, JOB_PRODUCTION,
                        JOB_INVOICING, JOB_SHIPPING, INVOICE, REMINDER];

const OPTIONS_ORDER_SUPER = [USER, JOB_INFO, JOB_DRAFTING, JOB_PRODUCTION,
                        JOB_INVOICING, JOB_SHIPPING, INVOICE, REMINDER, SYSTEM];

$SECTION_OPTIONS_COMMON = array();
foreach (OPTIONS_ORDER_COMMON as $section) {
    $SECTION_OPTIONS_COMMON[] = [$section, section_string($section)];
}
unset($section);

$SECTION_OPTIONS_SUPER = array();
