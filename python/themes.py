...
class Theme(sdk.python.entities.Entity):
    ...
    def __init__(self):
        ...
        self.json_property(str, "sms_token_page_template")
        ...
        self.json_property(str, "job_quote_requested_page_template")
        ...
        self.json_property(str, "job_quote_requested_page_error")
