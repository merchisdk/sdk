...
PRODUCT_TYPE_CORRESPONDING_JOB_TYPE = [
    job.PRODUCT_CREATION_MOD,
    job.PRODUCT_CREATION,
    job.SELLER,
    job.SELLER_MOD,
    job.PRODUCT_CREATION_MOD,
    job.SELLER_MOD,
    job.SUPPLIER_FULFILLMENT,
    job.PRODUCT_CREATION,
    job.SELLER,
    job.SUPPLIER_FULFILLMENT_INVENTORY,
    job.SELLER_GROUP_BUY,
    job.PRODUCT_RESELL_CREATION_MOD,
    job.PRODUCT_RESELL_CREATION,
