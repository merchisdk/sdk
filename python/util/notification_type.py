...
QUOTE_JOB_UPDATED = 53  # User
QUOTE_JOB_UPDATED_SENT = 54  # User
QUOTE_JOB_APPROVED_BY_CLIENT = 55  # User
QUOTE_JOB_APPROVED_BY_CLIENT_SENT = 56  # User
...
SHOW_USER_AVATAR = \
    [DRAFT_SENT, DRAFT_CHANGE_REQUEST, DRAFT_APPROVED,
     ...
     JOB_FILE_UPLOADED, QUOTE_JOB_UPDATED, QUOTE_JOB_UPDATED_SENT,
     QUOTE_JOB_APPROVED_BY_CLIENT, QUOTE_JOB_APPROVED_BY_CLIENT_SENT]
